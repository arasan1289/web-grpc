 ...
 *   !proto.grpc.gateway.testing.ServerDownloadRequest,
 *   !proto.grpc.gateway.testing.ServerDownloadResponse>}
 */
const methodDescriptor_EchoService_Download = new grpc.web.MethodDescriptor(
  '/grpc.gateway.testing.EchoService/Download',
  grpc.web.MethodType.SERVER_STREAMING,
  proto.grpc.gateway.testing.ServerDownloadRequest,
  proto.grpc.gateway.testing.ServerDownloadResponse,
  /**
   * @param {!proto.grpc.gateway.testing.ServerDownloadRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
  },
  proto.grpc.gateway.testing.ServerDownloadResponse.deserializeBinary
);
 ...
 *   !proto.grpc.gateway.testing.ServerDownloadResponse>}
 */
const methodInfo_EchoService_Download = new grpc.web.AbstractClientBase.MethodInfo(
  proto.grpc.gateway.testing.ServerDownloadResponse,
  /**
   * @param {!proto.grpc.gateway.testing.ServerDownloadRequest} request
   * @return {!Uint8Array}
...
/**
 * @param {!proto.grpc.gateway.testing.ServerDownloadRequest} request The request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @return {!grpc.web.ClientReadableStream<!proto.grpc.gateway.testing.ServerDownloadResponse>}
 *     The XHR Node Readable Stream
 */
proto.grpc.gateway.testing.EchoServiceClient.prototype.download =
    function(request, metadata) {
  return this.client_.serverStreaming(this.hostname_ +
      '/grpc.gateway.testing.EchoService/Download',
      request,
      metadata || {},
      methodDescriptor_EchoService_Download);
};
 ...
 *     The XHR Node Readable Stream
 */
proto.grpc.gateway.testing.EchoServicePromiseClient.prototype.download =
    function(request, metadata) {
  return this.client_.serverStreaming(this.hostname_ +
      '/grpc.gateway.testing.EchoService/Download',
      request,
